...
import FallingSpacemanScene from '../assets/3d/FallingSpaceman.glb'
import { useFrame } from '@react-three/fiber'

const FallingSpaceman = (props) => {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF(FallingSpacemanScene)
...
export default FallingSpaceman